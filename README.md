...
LLM's/ChatBots including ChatGPT, Gemini, and the Acanaconda Navigator, which uses open-source LLM models, were used throughout this project to debug code and structure certain sections. 
